...
function Cart({ items, total, onRemoveFromCart, onAddExistingItem, onRemoveExistingItem }: CartProps) {
              ...
              <div className="ml-4">
                ...
                <div className="mt-2 flex items-center gap-2">
                  <button
                    ...
                    onClick={() => onRemoveExistingItem && onRemoveExistingItem(item)}
                  >
                  ...
                  <button
                    className="p-1 hover:bg-gray-100 rounded"
                    onClick={() => onAddExistingItem && onAddExistingItem(item)}
                  >
